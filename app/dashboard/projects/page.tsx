...
const PROJECTS: Project[] = [
  {
    ...
    clientId: 1,
    description:
      "Full brand identity refresh including logo, color palette, typography system, and brand guidelines document.",
    agreedValue: 3200,
    amountPaid: 1600,
    ...
    overdue: false,
    internalNotes:
      "Client wants to see 3 logo concepts before moving to refinement phase.",
    attachments: ["brief.pdf", "mood_board.png"],
  },
  {
    id: 2,
    title: "Mobile app",
    ...
    clientId: 2,
    description:
      "Design and develop a cross-platform mobile app for internal team task management.",
    agreedValue: 8500,
    amountPaid: 2000,
    ...
    status: "in_progress",
    overdue: false,
    internalNotes: "Using React Native. Weekly syncs every Monday at 10am.",
  ...
  },
  {
    ...
    clientId: 3,
    description:
      "Write comprehensive developer documentation for the Streamline REST API.",
    agreedValue: 1800,
    amountPaid: 900,
    ...
    status: "in_review",
    overdue: false,
    internalNotes: "First draft submitted. Waiting on client review feedback.",
    attachments: [],
  },
  {
    id: 4,
    ...
    clientId: 4,
    description:
      "Redesign the analytics dashboard with improved data visualisation and mobile responsiveness.",
    agreedValue: 5600,
    amountPaid: 0,
    ...
    overdue: true,
    internalNotes:
      "Scope crept significantly — need to have a call about revised timeline.",
  ...
  },
  {
    ...
    clientId: 5,
    description:
      "Build a Shopify storefront with custom theme and product configurator.",
    agreedValue: 4200,
    amountPaid: 4200,
    ...
    overdue: false,
    internalNotes:
      "Delivered on time. Client very happy — potential for retainer.",
    attachments: [],
  },
  {
    id: 6,
    title: "Brand guidelines",
    client: "Driftwood Labs",
    clientId: 6,
    description:
      "Create a comprehensive brand guidelines document covering logo usage, typography and color.",
    agreedValue: 2400,
    amountPaid: 0,
    ...
    status: "pending",
    overdue: false,
    internalNotes: "Awaiting signed contract before starting.",
    attachments: [],
  },
]
  ...
  return (
    <div>
      ...
      >
        ...
        >
          ${(max - value).toLocaleString()} remaining
        </span>
      </div>
    </div>
  )
...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    if (clientParam) {
      const match = PROJECTS.find((p) => p.clientId === Number(clientParam))
        ...
        >
          ...
          >
            {[
              ...
              {
                label: "Remaining",
                value: `$${(selected.agreedValue - selected.amountPaid).toLocaleString()}`,
              },
