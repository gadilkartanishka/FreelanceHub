          ...
          {activeTab === "profile" && (
            <form action={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              <section>
                ...
                <p style={{ fontSize: 13, color: "#64748B", marginBottom: 24 }}>Update your profile details.</p>
                
                <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                    <div className="space-y-1.5">
                      <Label className="text-xs text-[#334155]">Full Name</Label>
                      <Input name="full_name" defaultValue={profile.full_name || ""} className="border-[#E2E8F0] bg-[#F8FAFC]" />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs text-[#334155]">Email Address (View-only)</Label>
                      <Input disabled value={profile.email || ""} className="border-[#E2E8F0] bg-[#F1F5F9] opacity-70" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-xs text-[#334155]">Phone Number</Label>
                    <Input name="phone" defaultValue={profile.phone || ""} placeholder="+1 (555) 000-0000" className="border-[#E2E8F0] bg-[#F8FAFC]" />
                  </div>
                </div>
              </section>
          ...
          {activeTab === "notifications" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              <section>
                ...
                <p style={{ fontSize: 13, color: "#64748B", marginBottom: 24 }}>These settings are currently read-only in the MVP.</p>
