        ...
        <form action={handleSubmit}>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              ...
              <input name="name" required placeholder="e.g. Sarah Chen" style={inputStyle} />
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <input name="phone" placeholder="+1 (555) 000-0000" style={inputStyle} />
              </div>
              <div>
                <label style={labelStyle}>Company</label>
                <input name="company" placeholder="Acme Co" style={inputStyle} />
              </div>
            </div>
            ...
            <div>
              ...
              <input name="tags" placeholder="design, branding, dev" style={inputStyle} />
            </div>
